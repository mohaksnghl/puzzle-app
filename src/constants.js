...
// Sound file paths
export const CLOCK_TICK_SOUND = "/sound/clock-tick.mp3";
export const TIMES_UP_SOUND = "/sound/times-up.mp3";
export const CORRECT_ANSWER_SOUND = "/sound/correct-answer.mp3";
export const CORRECT_WORD_SOUND = "/sound/correct-word.mp3";
